...
LabelBase.register(name="ChessFont", fn_regular="assets/fonts/chess_merida_unicode.ttf")
...
class ChessBoard(GridLayout):
    def __init__(self, luna_panel, **kwargs):
        ...
        self.sound_check = SoundLoader.load('assets/sounds/check.wav')
